...
const { sendgridSettings: { emails: { statusChanged } } } = require('../../config');
...
module.exports = {
    execute: async () => {
        ...
        servers.forEach(async (s) => {
            const { data: { rows: [user] } } = await selectInTable(tables.users, 'email,username', [{ name: 'id', value: s?.owner_id }]);
